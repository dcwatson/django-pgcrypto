...
class CryptoTests (unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.encrypt_bf = "x\364r\225\356WH\347\240\205\211a\223I{~\233\034\347\217/f\035\005"
        ...
        self.encrypt_aes = "\263r\011\033]Q1\220\340\247\317Y,\321q\224KmuHf>Z\011M\032\316\376&z\330\344"
        ...
        self.encrypt_aes_padded = "5M\304\316\240B$Z\351\021PD\317\213\213\234f\225L \342\004SIX\030\331S\376\371\220\\"
    ...
    def test_decrypt(self):
        c = Blowfish.new('pass', Blowfish.MODE_CBC)
        self.assertEqual(unpad(c.decrypt(self.encrypt_bf), c.block_size), 'sensitive information')
    ...
    def test_aes_pad(self):
        ...
        self.assertEqual(unpad(c.decrypt(self.encrypt_aes_padded), c.block_size), 'xxxxxxxxxxxxxxxx')
